      ...
      <div className="banner-block md:pt-20 pt-10">
        <div className="container">
          <div className="list-banner grid md:grid-cols-3 lg:gap-[30px] gap-[20px]">
            <div
              className="banner-item relative block duration-500 cursor-pointer"
            ...
            >
              ...
              <div className="banner-content absolute left-[30px] bottom-[30px]">
                ...
                <div className="text-button text-black relative inline-block pb-1 border-b-2 border-black duration-500 mt-2">
                  Shop Now
                </div>
              </div>
            </div>
